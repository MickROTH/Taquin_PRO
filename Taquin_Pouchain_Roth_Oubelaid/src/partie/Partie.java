...
public class Partie implements Serializable {
    ...
    /**
     * Constructeur privé : Crée une partie de taquin mais sans préciser le(s)
     * joueur(s).
     *
    ...
    /**
     * Méthode privée instanciant la liste des joueurs de la partie après
     * vérification de sa cohérence.
     *
     * @param joueurs Liste de joueurs
     * @throws IllegalArgumentException S'il n'y a pas exactement 1 ou 2
     * joueur(s) ou si le nombre de joueurs ne correspond pas au type de partie
     * (ex : 2 joueurs pour une partie SOLO).
     */
    ...
    /**
     * Vérifie si le type de partie donné fait partie des type des parties
     * connus.
     *
